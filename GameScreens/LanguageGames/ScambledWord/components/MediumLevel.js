...
const wordsData = [
  ...
  {
    word: "multiplication",
    hint: "Math operation for repeated addition",
  },
  {
    word: "division",
  ...
  {
    word: "percentage",
    hint: "A portion of a whole expressed as a fraction of 100",
  },
  {
    word: "fraction",
  ...
  {
    word: "decimal",
    hint: "A number with one or more digits to the right of the decimal point",
  },
  {
    word: "square",
  ...
  {
    word: "radicand",
    hint: "The number under the radical symbol",
  },
  {
    word: "exponent",
    hint: "The number that indicates how many times a base is multiplied by itself",
  },
  {
    word: "prime",
    hint: "A number greater than 1 that is not a product of two smaller natural numbers",
  },
  {
    word: "composite",
    hint: "A number that has more than two distinct positive divisors",
  },
  {
    word: "integer",
    hint: "A whole number that is not a fraction",
  },
];
